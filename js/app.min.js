/*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
	...
	w.Callbacks = function (e) {
		...
		when: function (e) {
			...
			if (t <= 1 && ($(e, a.done(s(n)).resolve, a.reject, !t), "pending" === a.state() || h(i[n] && i[n].then))) return a.then();
	...
	function Be(e, t, n) {
		...
		return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)), !d.pixelBoxStyles() && Re.test(a) && Ie.test(t) && (r = s.width, o = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = o, s.maxWidth = i)), void 0 !== a ? a + "" : a
	}
		...
		css: function (e, t) {
			return W(this, (function (e, t, n) {
				var r, o, i = {},
					a = 0;
				if (Array.isArray(t)) {
					for (r = $e(e), o = t.length; a < o; a++) i[t[a]] = w.css(e, t[a], !1, r);
					return i
				}
	...
	_t.href = Tt.href, w.extend({
		...
		ajax: function (t, n) {
			...
			if (d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), Bt(Mt, d, n, E), l) return E;
			...
			if (C = "abort", y.add(d.complete), E.done(d.success), E.fail(d.error), r = Bt(Rt, d, n, E)) {
